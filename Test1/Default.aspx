...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="row">
        ...
        <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional">
            <ContentTemplate>         
                <asp:Button ID="ButtonInsert" runat="server" Text="Добавить(Add) change(1)" CommandName="Insert" CommandArgument="New" OnCommand="ButtonInsert_Command" OnClientClick="NewFormData('0');" UseSubmitBehavior="False" />  
